...
const paths: Record<string, React.ReactNode> = {
  ...
  // 瓶子：瓶口 → 瓶颈 → 瓶肩 → 瓶身，一眼区别于 glass（酒杯）。
  bottle: <><path d="M10 2h4v3c0 2.2 3 2.6 3 5v9.4a1.6 1.6 0 0 1-1.6 1.6H8.6A1.6 1.6 0 0 1 7 19.4V10c0-2.4 3-2.8 3-5z"/><path d="M10 5h4"/></>,
  // 手掌食指：指人游戏的 pack 图标。
